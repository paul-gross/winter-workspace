...
- **[winter](https://codeberg.org/pgross/winter)** — the framework itself (Python CLI, workspace skills, docs)
- **[winter-harness](https://codeberg.org/pgross/winter-harness)** — extension curated for this meta workspace: Python conventions, exemplars, README guide
- **[winter-service-tmux](https://codeberg.org/pgross/winter-service-tmux)** — extension: tmux-based service orchestration (`./up`/`./down`/`./status`)
- **[winter-product](https://codeberg.org/pgross/winter-product)** — extension: product planning agents and skills
- **[winter-workflow](https://codeberg.org/pgross/winter-workflow)** — extension: agentic workflow conventions and the `/wf-commit` skill
...
See `CLAUDE.md` for workspace conventions and `ai/project/contributing.md` for delivery rules.
